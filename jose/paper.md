...
Discrete mathematics is a crucial part of the computer science curriculum, as recognized by the Joint Task Force on Computer Science Curricula, a collaboration among the Association for Computing Machinery (ACM), the IEEE Computer Society, and the Association for the Advancement of Artificial Intelligence (AAAI) [@kumar:2024].  Discrete mathematics is a requirement in ABET accreditation criteria [@abetcs:2026].  In a survey of 199 Computer Science (BA/BS) programs, [@brodley:2024] reported 99% require discrete mathematics. Moreover, this report showed  that discrete mathematics is a prerequisite for nearly all core computer science courses, including data structures (73 programs), algorithms (117 programs), and databases (17 programs), as well as advanced topics such as parallel computing and machine learning [@brodley:2024].

Despite its significance, students often find the subject challenging due to its abstract nature, therefore is a potential barrier to student progression. Traditional courses focus on formal proof and symbolic reasoning, often without including any computational work. As a result, students may not see how discrete mathematics relates to applications in computer science. 
